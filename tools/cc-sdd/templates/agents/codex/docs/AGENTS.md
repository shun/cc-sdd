...
Codex loads the repo-local skills installed in `.agents/skills/`
automatically. Run `/skills` to browse available skills, or type `$` to mention
one directly in chat.
